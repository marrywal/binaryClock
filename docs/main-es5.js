...
var ClockComponent = /** @class */ (function () {
    ...
    ClockComponent.prototype.ngOnInit = function () {
        var _this = this;
        setInterval(function () { return _this.getTime(); }, 1000);
    };
    ClockComponent.prototype.getTime = function () {
    ...
    ClockComponent.prototype.setActive = function (key, position, value) {
        if (key) {
            var timeNumber = parseInt(key.charAt(position));
            if (value === 1) {
